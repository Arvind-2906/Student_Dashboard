...
export default function Sidebar({ currentTab = 'dashboard', onTabChange }: SidebarProps) {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 h-16 md:sticky md:top-0 md:h-screen w-full md:w-20 lg:w-64 bg-zinc-950/80 backdrop-blur-xl border-t md:border-t-0 md:border-r border-zinc-900/60 flex md:flex-col justify-between p-3 md:p-4 lg:p-6 z-50 transition-all duration-300">
